      ...
      <PremiumLayout user={{ name: 'Lenny De K.' }}>
        <div className="flex items-center justify-center h-[60vh]">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Afspraak Gepland!</h2>
            <p className="text-gray-500 dark:text-gray-400">Je wordt doorgestuurd naar de afspraken pagina...</p>
          </div>
        </div>
      </PremiumLayout>
    );
